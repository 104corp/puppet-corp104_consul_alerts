# Define: corp104_consul_alerts::daemon
#
# This define managed corp104_consul_alerts daemons that don't have their own class
#
#  [*notify_service*]
...
define corp104_consul_alerts::daemon (
  ...
  Optional[String] $env_file_path = $corp104_consul_alerts::env_file_path,
) {
  ...
  if $env_file_path != undef {
    file { "${env_file_path}/${name}":
      ...
      content => template('corp104_consul_alerts/daemon.env.erb'),
      notify  => $notify_service,
    }
  }
